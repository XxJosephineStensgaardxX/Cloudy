				...
				<div class="container">
					<div class="checkout__inner">
						<form class="checkout__form" action="" method="POST">
							...
							<div
								class="input__wrapper input__wrapper-double input__wrapper-spaced"
							>
						...
						<ul class="orders">
							<li class="order__item">
								<img
									src="./img/catalogus_sokken_stripes_red.png"
									alt="catalogus_sokken_stripes_red"
									class="order__image"
								/>
							...
							<li class="order__item">
								<img
									src="./img/catalogus_sokken_uni_blue.png"
									alt="catalogus_sokken_uni_blue"
									class="order__image"
								/>
								<div class="order__item-inner">
